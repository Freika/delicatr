...
class FeedEntriesControllerTest < ActionController::TestCase
  ...
  test "should update feed_entry" do
    patch :update, id: @feed_entry, feed_entry: { guid: @feed_entry.guid, name: @feed_entry.name, published_at: @feed_entry.published_at, summary: @feed_entry.summary, url: @feed_entry.url }
    assert_redirected_to feed_entry_path(assigns(:feed_entry))
  end
